...
public class BarChartR extends JFrame{
    ...
    public BarChartR(String appTitle, String chartTitle, 
            LinkedList<Statistics> stats){
        super(appTitle);
        this.stats = stats;
        ...
        try{
            ChartUtilities.saveChartAsPNG(new File("charts/rchart.png"), chart,
                    600, 500);
        }catch(Exception e){
            e.printStackTrace();
        }
    ...
    private CategoryDataset createDataset(){
        ...
        private JFreeChart createChart(CategoryDataset dataset, String chartTitle){
            JFreeChart chart = ChartFactory.createBarChart3D(chartTitle, "Βαθμός"
                    + " ενεργοποίησης συστήματος (ρ)",
